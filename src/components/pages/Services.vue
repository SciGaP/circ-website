<template>
	<div class="link-text">
		<div class="f-s pos-r global-padding">
			<div style="width:50%;margin-right:3.6%;margin-top:109px">
				<div><span style="font-size:56px;line-height:120%"><b>Solutions <span class="crim-colo">customized</span> for your <span class="crim-colo">Problems</span></b></span></div>
				<p style="font-size:20px;line-height:160%;color:#45382B">We take care of all your high performance computing requirements and the computational Infrastructure you need to perform Groundbreaking Research.</p>
				<div class='scroll_down' style="padding-left:10px;padding-top:57px;">
          <div class=square>
			...
			<div>
				<img src="@/assets/Service_logo.png" alt="">
			</div>
		</div>
		<div class="global-padding">
			<div class="block" style="left:0;opacity:0.02;z-index:-1">
		...
		<div class="global-padding" style="background:#E5E5E588;padding-top:1rem">
